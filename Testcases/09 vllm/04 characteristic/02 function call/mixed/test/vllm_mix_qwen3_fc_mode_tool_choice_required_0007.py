...
class vllm_mix_qwen3_fc_mode_tool_choice_required_0007(FunctionCallCaseBase):
    """
    CaseNumber:
        vllm_mix_qwen3_fc_mode_tool_choice_required_0007
    RunLevel:
        Level 1
    EnvType:
        None
    ...
    def procedure(self):
        ...
        self.assertTrue(self.get_tool_calls(response), f"required 模式未触发工具: {response}")

...
class vllm_mix_qwen3_fc_observe_tool_calls_with_content_0024(FunctionCallCaseBase):
    """
    CaseNumber:
        vllm_mix_qwen3_fc_observe_tool_calls_with_content_0024
    RunLevel:
        Level 1
    EnvType:
        None
    ...
    def procedure(self):
        ...
        self.assertTrue(tool_calls, f"期望模型调用工具: {response}")
